...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-doc --disable-ffmpeg --disable-ffplay --disable-ffserver --enable-cross-compile --arch=arm --target-os=darwin --cc=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc --as='gas-preprocessor/gas-preprocessor.pl /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc' --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk --cpu=cortex-a8 --extra-cflags='-arch armv7' --extra-ldflags='-arch armv7 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk' --enable-pic --enable-decoder=rawvideo --disable-asm --disable-bzlib --extra-cflags='-mfpu=neon' --enable-decoder=h264
prefix=/usr/local
...
CC_IDENT=llvm-gcc 4.2.1 (LLVM build 2410.2.00)
ARCH=c
...
LD=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc
DEPCC=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=gas-preprocessor/gas-preprocessor.pl /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/usr/bin/gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=ar
...
LN_S=ln -s -f
STRIP=strip -x
CPPFLAGS= --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS=  -arch armv7 -mfpu=neon -mcpu=cortex-a8 -std=c99 -fomit-frame-pointer -fPIC -mthumb -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -O3 -fno-math-errno -mllvm -stack-alignment=16
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -arch armv7 -mfpu=neon -mcpu=cortex-a8 -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -arch armv7 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk  --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS6.1.sdk -Wl,-dynamic,-search_paths_first
LDFLAGS-ffserver=-Wl,-bind_at_load
...
TARGET_EXEC=
TARGET_PATH=$(CURDIR)
LIBS-ffplay=-L/opt/local/lib -lSDLmain -lSDL -Wl,-framework,Cocoa
CFLAGS-ffplay=-I/opt/local/include/SDL -D_GNU_SOURCE=1 -D_THREAD_SAFE
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-liconv -lm -lz 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
